        ...
        <div className="h-[70px] flex items-center justify-between px-12" style={{ borderBottom: "1px solid rgba(255,255,255,0.06)" }}>
          ...
          <div className="relative flex-shrink-0" ref={profileRef}>
            ...
            <div
              ...
              style={{ background: "#0A0A0A", border: profileOpen ? "1px solid rgba(127,190,192,0.12)" : "1px solid transparent", boxShadow: profileOpen ? "0 16px 48px rgba(0,0,0,0.9)" : "none", maxHeight: profileOpen ? "120px" : "0px", opacity: profileOpen ? 1 : 0, pointerEvents: profileOpen ? "auto" : "none" }}
            >
              <div className="p-2">
